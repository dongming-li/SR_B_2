...
/**
 * The class is the homepage class for user
 */
public class HomePage extends AppCompatActivity implements ExpandableListView.OnChildClickListener, ExpandableListView.OnGroupClickListener {
    ...
    /**
     * An URL that fetches admin message for user
     */
    ...
    private void setNavDrawer() {
        ...
        MySingleton.getInstance(HomePage.this).addToRequestQueue(stringRequest2);
    }

    /**
     * This method will fetch message sent from admin to user
     */
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        if (childItem == "Your Profile") {
            Intent viewProfileIntent = new Intent(HomePage.this, ViewProfileV2.class);
            ;
        ...
        if (childItem == "Edit Profile") {
            Intent editProfileIntent = new Intent(HomePage.this, edit_screen.class);
        ...
        if (childItem == "Your Office") {
            Intent viewOffice = new Intent(HomePage.this, ViewOfficeV2.class);
        ...
        if (childItem == "Create Office") {
            Intent createOffice = new Intent(HomePage.this, AddOffice.class);
            startActivity(createOffice);
            parent.collapseGroup(groupPosition);
        }

        if (childItem == "Create Event") {
            Intent createEvent = new Intent(HomePage.this, InsertEvent.class);
    ...
    public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
        ...
        if (groupItem == "Support") {
            Intent supportIntent = new Intent(HomePage.this, SupportPage.class);
    ...
    /**
     * This method deletes the message sent from admin after being read by user
     */
    public void deleteAdminMessage(){
        ...
        MySingleton.getInstance(HomePage.this).addToRequestQueue(stringRequest5);
    }
}
